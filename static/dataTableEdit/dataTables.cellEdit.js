 ...
 *	This is an edited version of CellEdit
 *	Edited by Tamal Dev
 *	Original version https://github.com/ejbeaty/CellEdit
 */
...
jQuery.fn.dataTable.Api.register('MakeCellsEditable()', function (settings) {
    ...
    jQuery.fn.extend({
        updateEditableCell: function (callingElement) {
            ...
            var field_name = inputField.attr("name");
            if (!newValue && ((settings.allowNulls) && settings.allowNulls != true)) {
                // If columns specified
                if (settings.allowNulls.columns) {
                    // If current column allows nulls
                    if (settings.allowNulls.columns.indexOf(columnIndex) > -1) {
                        _update(field_name, newValue);
                    } else {
                        _addValidationCss();
                    }
            ...
            function _update(field_name, newValue) {
                var oldValue = cell.data();
                cell.data(newValue);
                //Return cell & row.
                settings.onUpdate(field_name, newValue, cell, row, oldValue);
            }
            // Get current page
...
function getInputHtml(currentColumnIndex, settings, oldValue) {
    ...
    switch (inputType) {
        case "none":
            ...
            break;
        case "tab":
			input.html = "<a href='javascript:void(0);' onclick='open_widow(this);'>Edit</a><a href='javascript:void(0);' style='display: none;' id='"+cancle_a_id+"' onclick='$(this).cancelEditableCell(this)'>Cancel</a>";
            break;
        case "list":
			var field_name = inputSetting.field_name;
            input.html = startWrapperHtml + "<select name='" + field_name + "' class='" + inputCss + "' onchange='$(this).updateEditableCell(this);'>";
            ...
            input.html = input.html + "</select>&nbsp;<a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>OK</a> <a href='javascript:void(0);' class='" + cancelCss + "' id='"+cancle_a_id+"' onclick='$(this).cancelEditableCell(this)'>Cancel</a>" + endWrapperHtml;
            input.focus = false;
            break;
        case "list-confirm":
			var field_name = inputSetting.field_name;
            input.html = startWrapperHtml + "<select name='" + field_name + "' class='" + inputCss + "'>";
            $.each(inputSetting.options, function (index, option) {
                if (oldValue == option.value) {
                   input.html = input.html + "<option value='" + option.value + "' selected>" + option.display + "</option>"
                } else {
        ...
        case "datepicker-confirm":
			...
			var field_name = inputSetting.field_name;
			input.html = startWrapperHtml + "<input name='" + field_name + "' id='ejbeatycelledit' type='text' name='date' class='datepick " + inputCss + "' value='" + oldValue + "'></input> &nbsp;<a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>OK</a> <a href='javascript:void(0);' class='" + cancelCss + "' id='"+cancle_a_id+"' onclick='$(this).cancelEditableCell(this)'>Cancel</a>" + endWrapperHtml;
        ...
        case "text-confirm": 
			var field_name = inputSetting.field_name;
			input.html = startWrapperHtml + "<input name='" + field_name + "' id='ejbeatycelledit' class='" + inputCss + "' value='"+oldValue+"'" + (listenToKeys ? " onkeyup='if(event.keyCode==13) {$(this).updateEditableCell(this);} else if (event.keyCode===27) {$(this).cancelEditableCell(this);}'" : "") + "></input>&nbsp;<a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>OK</a> <a href='javascript:void(0);' class='" + cancelCss + "' id='"+cancle_a_id+"' onclick='$(this).cancelEditableCell(this)'>Cancel</a>" + endWrapperHtml;
            break;
        ...
        case "textarea":
			var field_name = inputSetting.field_name;
            input.html = startWrapperHtml + "<textarea name='" + field_name + "' id='ejbeatycelledit' class='" + inputCss + "'  onfocusout='$(this).updateEditableCell(this)' >"+oldValue+"</textarea>" + endWrapperHtml;
            break;
        case "textarea-confirm":
			var field_name = inputSetting.field_name;
            input.html = startWrapperHtml + "<textarea name='" + field_name + "' id='ejbeatycelledit' class='" + inputCss + "'>"+oldValue+"</textarea><a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>OK</a> <a href='javascript:void(0);' class='" + cancelCss + "' id='"+cancle_a_id+"' onclick='$(this).cancelEditableCell(this)'>Cancel</a>" + endWrapperHtml;
            break;
		case "number-confirm" :
			var field_name = inputSetting.field_name;
			input.html = startWrapperHtml + "<input name='" + field_name + "' id='ejbeatycelledit' type='number' class='" + inputCss + "' value='"+oldValue+"'" + (listenToKeys ? " onkeyup='if(event.keyCode==13) {$(this).updateEditableCell(this);} else if (event.keyCode===27) {$(this).cancelEditableCell(this);}'" : "") + "></input>&nbsp;<a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>OK</a> <a href='javascript:void(0);' class='" + cancelCss + "' id='"+cancle_a_id+"' onclick='$(this).cancelEditableCell(this)'>Cancel</a>" + endWrapperHtml;
			break;
		case "number" :
			var field_name = inputSetting.field_name;
			input.html = startWrapperHtml + "<input name='" + field_name + "' id='ejbeatycelledit' type='number' class='" + inputCss + "' value='"+oldValue+"'" + (listenToKeys ? " onkeyup='if(event.keyCode==13) {$(this).updateEditableCell(this);} else if (event.keyCode===27) {$(this).cancelEditableCell(this);}'" : "") + "></input>&nbsp;<a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>OK</a> <a href='javascript:void(0);' class='" + cancelCss + "' id='"+cancle_a_id+"' onclick='$(this).cancelEditableCell(this)'>Cancel</a>" + endWrapperHtml;
